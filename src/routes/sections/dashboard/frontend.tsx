...
export function getFrontendDashboardRoutes(): RouteObject[] {
	const frontendDashboardRoutes: RouteObject[] = [
		...
		{ path: "dashboard/invoice/receipt-preview", element: Component("/pages/dashboard/invoice/receipt-preview") },
		...
		{ path: "dashboard/coupons/edit/:id", element: Component("/pages/dashboard/coupons/edit") },
		{ path: "dashboard/accounting-center", element: <Navigate to="/dashboard/accounting" replace /> },
		{ path: "dashboard/cash-transactions", element: <Navigate to="/dashboard/accounting" replace /> },
		{
		...
		{ path: "dashboard/loan/receipt-preview", element: Component("/pages/dashboard/invoice/receipt-preview") },
