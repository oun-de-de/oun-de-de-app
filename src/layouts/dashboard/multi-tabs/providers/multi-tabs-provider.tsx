...
export function MultiTabsProvider({ children }: { children: React.ReactNode }) {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: derive active tab path
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: sync tabs with active route
	useEffect(() => {
		if (!currentRouteMeta) return;
